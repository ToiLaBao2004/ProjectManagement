...
import { createTask, getTasksByProject, updateTask, getTaskByUserAssigner, makeComment, getTaskDetail, deleteTask } from '../controllers/taskController.js';
...
taskRouter.get('/:taskId', authMiddleware, getTaskDetail);
