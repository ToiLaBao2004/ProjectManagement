...
export async function editMemberRole(req, res) {
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Member role updated.", project });
  } catch (error) {
    console.log(error);
    res.status(500).json({ success: false, message: "Server error." });
  }
...
export async function addSprintToProject(req, res) {
  try {
    ...
    res
      .status(200)
      .json({ success: true, message: "Sprint added to project.", project });
  } catch (error) {
    console.log(error);
    res.status(500).json({ success: false, message: "Server error." });
  }
...
export async function removeSprintFromProject(req, res) {
  try {
    ...
    if (!sprint) {
      return res
        .status(404)
        .json({ success: false, message: "Sprint not found in project." });
    }
