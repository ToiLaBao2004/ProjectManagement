            ...
            <div className='flex items-center justify-between px-4 py-3 md:px-6 max-w-7xl mx-auto'>
                ...
                <div className='flex items-center gap-2 cursor-pointer group'
                    onClick={() => navigate('/')}>
                        ...
                        group-hover:scala-105 transition-all duration-300'>
                ...
                <div className='flex items-center gap-4'>
                    <button className='p-2 text-gray-600 hover:text-sky-400 transition-colors duration-300
                    ...
                    <div ref={menuref} className='relative'>
                        ...
                        py-2 rounded-full cursor-pointer hover:bg-sky-50 transition-colors duration-300 border
