...
const Layout = ({ onLogout, user }) => {
    ...
    const stats = useMemo(() => {
        ...
        const pendingCount = tasks.length - completedTasks
        ...
        return (
            ...
            duration-300 hover:border-purple-100 group'>
                <div className='flex items-center gap-2'>
                    <div className='p-1.5 rounded-lg bg-gradient-to-b from-sky-500/10 to-sky-500/10 group-hover:from-sky-500/20
                    group-hover:to-blue-500/20'>
                        {icon}
                    </div>
                    <div className='min-w-0'>
                        <p className='text-lg sm:text-xl font-bold bg-gradient-to-r from-sky-500 to-blue-600
                        bg-clip-text text-transparent'>
                            {value}
                        </p>
                        <p className='text-sx text-gray-500 font-medium'>
                            {title}
                        </p>
                    </div>
                </div>
                            ...
                            <div className='space-y-2 sm:space-y-3'>
                                <div className='flex items-center justify-between text-gray-700'>
                                    <span className='text-sm sm:text-sm font-medium flex items-center gap-1.5'>
                                        <Circle className='w-2.5 h-2.5 sm:w-3 sm:h-3 text-sky-500 fill-blue-500' />
                                        Task Progress
                                    </span>
                                    <span className='text-sm bg-blue-100 text-sky-700 px-1.5 py-0.5 sm:px-2
                                    rounded-full'>
